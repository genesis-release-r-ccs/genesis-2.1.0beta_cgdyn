...
contains
  ...
  !> @brief        show usage of GENESIS CGDYN control file
  !! @authors      NT
  ...
  subroutine show_ctrl(ctrl_str, run_mode)
    ...
    if (run_mode /= 'md'  .and. &
      ...
      write(MsgOut,'(A)') ' '
      write(MsgOut,'(A)') '# check control parameters of md'
      write(MsgOut,'(A)') '  % ./cgdyn -h '//trim(ctrl_str)//' md'
      write(MsgOut,'(A)') ' '
      write(MsgOut,'(A)') '# check control parameters of min'
      write(MsgOut,'(A)') '  % ./cgdyn -h '//trim(ctrl_str)//' min'
      write(MsgOut,'(A)') ' '
      write(MsgOut,'(A)') '# check control parameters of remd'
      write(MsgOut,'(A)') '  % ./cgdyn -h '//trim(ctrl_str)//' remd'
      write(MsgOut,'(A)') ' '
      write(MsgOut,'(A)') '# check control parameters of rpath'
      write(MsgOut,'(A)') '  % ./cgdyn -h '//trim(ctrl_str)//' rpath'
      write(MsgOut,'(A)') ' '
      return
